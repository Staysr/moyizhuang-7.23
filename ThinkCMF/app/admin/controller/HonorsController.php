 ...
 * )
 */
class HonorsController extends AdminBaseController
{
    ...
    public function add_honors()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $data_insert['honors_time'] = time();
            $list = Db::name('honors')->insert($data_insert);
    ...
    public function honors_list()
    {
        $list = Db::name("honors")->select();
    ...
    {
        $id = input("id");
        $list = Db::name("honors")->where("id = $id")->delete();
        if ($list){
            $this->success("删除成功！");
        }else{
            $this->error("删除失败！");
    ...
    public function add_marquee(){
        if ($this->request->isPost()) {
            ...
            $list = Db::name('marquee')->insert($data_insert);
    ...
    {
        $id = input("id");
        $list = Db::name("marquee")->where("id = $id")->delete();
        if ($list){
            $this->success("删除成功！");
        }else{
            $this->error("删除失败！");
    ...
    public function particulars_one()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $uniquevalue = $data['post']['post_uniquevalue'];//唯一值
            ...
            $data_insert['uniquevalue'] = $uniquevalue;
    ...
    public function honors_index(){
        ...
        if ($this->request->isPost()) {
            ...
            $data_insert['thumbnail'] = $thumbnail;
            $data_insert['honors_index_time'] = time();

            $list = Db::name('honors_index')->insert($data_insert);
    ...
    public function honors_index_list(){
        $list = Db::name("honors_index")->select();
        $this->assign("list",$list);
        return $this->fetch();
    }
    public function honors_index_delete()
    {
        $id = input("id");
        $list = Db::name("honors_index")->where("id = $id")->delete();
        if ($list){
            $this->success("删除成功！");
        }else{
            $this->error("删除失败！");
