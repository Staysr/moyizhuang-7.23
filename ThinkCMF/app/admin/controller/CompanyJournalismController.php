 ...
 * )
 */
class CompanyJournalismController extends AdminBaseController
{
    ...
    public function index()
    {
        if ($this->request->isPost()) {
            ...
            $post_title_one = $data['post']['post_title_one'];//标题
            ...
            $post_content = $data['post']['published_time'];//内容
...
//            die();
            ...
            $data_insert['post_title_one'] = $post_title_one;
            ...
            $data_insert['published_time'] = $post_content;

            $list = Db::name('newsinfo')->insert($data_insert);
    ...
    public function companyjournalism_list (){
        $list = Db::name("newsinfo")->select();
    ...
    {
        $id = input("id");
        $list = Db::name("newsinfo")->where("id = $id")->delete();
        if ($list){
            $this->success("删除成功！");
        }else{
            $this->error("删除失败！");
