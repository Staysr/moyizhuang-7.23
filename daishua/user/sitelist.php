...
$sql="insert into `shua_site` (`power`,`upzid`,`domain`,`domain2`,`user`,`pwd`,`rmb`,`qq`,`sitename`,`keywords`,`description`,`anounce`,`alert`,`addtime`,`endtime`,`status`) values ('1','".$userrow['zid']."','".$domain."',NULL,'".$user."','".$pwd."','0','".$qq."','".$sitename."','".$keywords."','".$description."','".addslashes($anounce)."','".addslashes($alert)."','".$date."','".$endtime."','1')";
if($DB->query($sql)){
