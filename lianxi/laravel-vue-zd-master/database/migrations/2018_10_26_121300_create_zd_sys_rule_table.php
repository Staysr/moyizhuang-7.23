...
class CreateZdSysRuleTable extends Migration {
	...
	public function up()
	{
		Schema::create('zd_sys_rule', function(Blueprint $table)
		{
			...
			$table->boolean('isverify')->default(1)->comment('需要验证: 0 不需要 1需要');
			$table->boolean('level')->nullable()->default(0)->comment('级别');
			$table->boolean('isclick')->nullable()->default(0)->comment('是否可点击');
