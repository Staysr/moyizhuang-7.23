...
class CreateBaseDriverSelfBill201706Table extends Migration {
	...
	public function up()
	{
		Schema::create('base_driver_self_bill_2017-06', function(Blueprint $table)
		{
	...
	{
		Schema::drop('base_driver_self_bill_2017-06');
	}
