...
class CreateBaseDriverSelfBill201710Table extends Migration {
	...
	public function up()
	{
		Schema::create('base_driver_self_bill_2017-10', function(Blueprint $table)
		{
	...
	{
		Schema::drop('base_driver_self_bill_2017-10');
	}
