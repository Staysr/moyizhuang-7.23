...
/* scopeId */
var __vue_scopeId__ = "data-v-2e2afaa9"
...
Component.options.__file = "resources/assets/admin/js/views/base/driver/social.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2e2afaa9", Component.options)
  } else {
    hotAPI.reload("data-v-2e2afaa9", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("0fe44bac", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2e2afaa9\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./social.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2e2afaa9\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./social.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var _socialView = __webpack_require__(552);

var _socialView2 = _interopRequireDefault(_socialView);
...
exports.default = {
    components: {
        ...
        MyLists: _myLists2.default, mView: _socialView2.default
    },
    name: 'social',
            ...
            columns: [{
                ...
                render: function render(h, _ref6) {
                    ...
                    return h(
                        'span',
                        null,
                        [row.is_plat_service_fee ? '已缴纳' : '未缴纳']
                    );
                }
            }, {
                title: '成功配送次数',
    ...
    methods: {
        search: function search() {
            ...
            this.$refs['searchForm'].validate(function (valid) {
                if (valid) {
                    _this2.loading = true;
                    _this2.$http.get('driver/social', { params: _this2.request(page) }).then(function (res) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-60ce9f0e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/admin/js/views/base/driver/social-view.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-60ce9f0e", Component.options)
  } else {
    hotAPI.reload("data-v-60ce9f0e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("446cf9f5", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-60ce9f0e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./social-view.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-60ce9f0e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./social-view.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            _this.$http.get('driver/social/' + _this.data.id).then(function (res) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-60ce9f0e", module.exports)
  }
}
        ...
        [
          ...
          _c(
            ...
            [
              ...
              _c(
                "FormItem",
                { attrs: { label: "app状态", "label-width": 60 } },
                [
                  _c("true-or-false", {
                    attrs: { "false-value": "离职", "true-value": "在职" },
                    model: {
                      value: _vm.searchForm.app_status,
                      callback: function($$v) {
                        _vm.$set(_vm.searchForm, "app_status", $$v)
                      },
                      expression: "searchForm.app_status"
                    }
                  })
                ],
                1
              ...
              _c(
                "FormItem",
                { attrs: { label: "车辆型号", "label-width": 60 } },
                [
                  _c("remote", {
                    attrs: {
                      "remote-url": "cartype/select",
                      ready: true,
                      remote: false
                    },
                    model: {
                      value: _vm.searchForm.car_type_id,
                      callback: function($$v) {
                        _vm.$set(_vm.searchForm, "car_type_id", $$v)
                      },
                      expression: "searchForm.car_type_id"
                    }
                  })
                ],
                1
              ...
              _c(
                "FormItem",
                { attrs: { label: "平台服务费", "label-width": 80 } },
                [
                  _c("true-or-false", {
                    attrs: { "true-value": "已缴纳", "false-value": "未缴纳" },
                    model: {
                      value: _vm.searchForm.is_plat_service_fee,
                      callback: function($$v) {
                        _vm.$set(_vm.searchForm, "is_plat_service_fee", $$v)
                      },
                      expression: "searchForm.is_plat_service_fee"
                    }
                  })
                ],
                1
              ...
              _c(
                "FormItem",
                { attrs: { label: "保证金", "label-width": 60 } },
                [
                  _c("true-or-false", {
                    attrs: { "true-value": "已缴纳", "false-value": "未缴纳" },
                    model: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-2e2afaa9", module.exports)
  }
}
