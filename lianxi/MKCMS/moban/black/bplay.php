			...
			<div class="hy-layout clearfix"><div style="margin-top:0px"><?php echo get_ad(13)?></div>
				...
				<div class="tab-content">
					<div class="hy-play-list tab-pane fade in active" id="list3">
						<div class="item">
							<div class="plot">
							<font color="#FFFFFF"><?php echo $d_content; ?></font></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-md-3 col-sm-12 hy-main-side hidden-sm hidden-xs">
			<div class="hy-layout clearfix">
				...
				<div class="hy-video-ranking side clearfix">
					<div class="head">
						<a class="text-muted pull-right" href="<?php echo $mkcms_domain;?>vlist.php?cid=0">更多 <i class="icon iconfont icon-right"></i></a>
...
$ccb=$cc.$row['d_id'];	
			...
			echo '<li class="text-overflow"><span class="pull-right text-color">->></span><a href="'.$ccb.'.html" title="'.$row['d_name'].'">
						<em class="number active ">福利</em>'.$row['d_name'].'</a></li>';
		}?>			
