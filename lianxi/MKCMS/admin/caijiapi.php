...
<select id="laiyuan" class="form-control" name="laiyuan">
			...
			<option value="http://www.zuidazy.net/">最大资源（推荐）</option>
            ...
            <option value="http://www.8laoye.com/">8老爷资源网（推荐）</option>
            ...
            <option value="http://www.kkzy.cc/">快快资源（不推荐）</option>
...
?>
								<tr>
								<td><a target="_blank" href="cms_cj_add.php<?php echo $pingfen?>&zd=<?php echo $laiyuan?>" style="color: #337ab7;
    text-decoration: none;"><?php echo $cs?></a></td>
								<td><?php echo $lx?></td>
								<td><?php echo $sj?></td>
								<td><a class="btn btn-success" target="_blank" href="cms_cj_add.php<?php echo $pingfen?>&zd=<?php echo $laiyuan?>" style="border-radius:4px;">采集</a></td>
							</tr>							
