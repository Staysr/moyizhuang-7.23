...
//自定义滚动条
(function () {
    zns.site.fx.scrollBar = function (con, bar, area,			//元素：滚动条、滑块、滚轮区
                                      dir_x, dir_y,			//方向：true
...
(function () {
    ...
    zns.site.user.create = function () {
        ...
        function openDialog(fnSucc) {
            ...
            //运动
            flex(oLoginBox, {bgAlpha: 0, boxAlpha: 0, scale: 3}, {
                bgAlpha: 80,
                boxAlpha: 100,
                scale: 1
            }, function (now) {
        ...
        function closeDialog() {
            ...
            //运动
            buffer(oLoginBox, {bgAlpha: 80, boxAlpha: 100, scale: 1}, {
                bgAlpha: 0,
                boxAlpha: 0,
                scale: 3
            }, function (now) {
        ...
        function onPageCreate(oldPage, newPage) {
            ...
            var timer = setInterval(function () {
                buffer(
                    ...
                    {
                        left: aPage[oldPage].offsetLeft + oPage.offsetLeft,
                        top: aPage[oldPage].offsetTop + oPage.offsetTop,
                        opacity: 0,
                        width: 24,
                        height: 24
                    },
                        ...
                        if (!iWait) {
                            ...
                            var timer = setInterval(function () {
                                buffer(
                                    aDiv[i],
                                    {
                                        left: aPage[newPage].offsetLeft + oPage.offsetLeft,
                                        top: aPage[newPage].offsetTop + oPage.offsetTop,
                                        opacity: 0,
                                        width: 24,
                                        height: 24
                                    },
...
(function () {
    ...
    zns.site.fx.fast_nav.create = function () {
        ...
        function openFast(fnEnd) {
            ...
            flex(oDiv, {right: 60, top: 50}, {
                right: document.documentElement.clientWidth / 2,
    ...
    (function () {
        ...
        zns.site.fx.product_s.create = function (aData) {
            ...
            function tab(now) {
                ...
                setClass(aLi[m(iNow - 2)], 'li_3d left2', function () {
                    ready = true;
                });
