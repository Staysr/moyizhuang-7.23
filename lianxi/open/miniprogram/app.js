...
App({
  d: {
    appId:"wx3e74ca1a57a58ed8", // 小程序appid
    appKey:"d73fa38f74dee1c430143fbc3441151f", // 小程序密钥
    purchase: 0,//设置购物车刷新
    ...
    h_color:'#FF63477',
    order:{},
    ceshiUrl: 'http://localhost/lianxi1/open/LKT/index.php?module=api&software_name=3&edition=1.0', 
  },
