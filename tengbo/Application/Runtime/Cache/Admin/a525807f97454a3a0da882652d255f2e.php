...
<div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 公司历程</strong></div>
    <div class="padding border-bottom">
        <a class="button border-yellow" href="<?php echo U('System/course_add');?>" ><span class="icon-plus-square-o"></span> 添加历程</a>
    </div>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <div class="button-group">
                        <a class="button border-main" href="<?php echo U('System/course_update',array('id'=>$v['id']));?>"><span class="icon-edit"></span>查看编辑</a>
...
<script>
    function del(id,that){
        if(confirm('确定要删除吗?')){
            ...
            $.ajax({
                type:"post",
                url:"<?php echo U('System/course_del');?>",
                data:{id:id},
