    ...
    <div class="padding border-bottom">
        <form method="post" action="<?php echo U('case_list');?>" id="myform">
            <ul class="search" style="padding-left:10px;">
                <li>
                    <a class="button border-main icon-plus-square-o" href="<?php echo U('Job/job_add');?>">添加招聘信息</a>
                </li>
            </ul>
        </form>
    </div>
    <form method="post" action="" id="listform">
        <table class="table table-hover text-center">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v["require"]); ?></td>
                    <td><?php echo ($v["add_time"]); ?></td>
                    <td>
                        <div class="button-group">
                            <a class="button border-main" href="<?php echo U('Job/job_update',array('id'=>$v['id']));?>"><span class="icon-edit"></span>查看编辑</a>
