...
<div class="panel admin-panel">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加<?php if($_REQUEST['type']==1): ?>行业动态<?php else: ?>公司动态<?php endif; ?></strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea type="text" name="intro" class="input" style="height:100px;width: 100%" data-validate="required:请输入简介"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
