...
<div class="panel admin-panel">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加历程</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="number" class="input w50" value="" id="year" name="year" data-validate="required:请选择年份" readonly/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <textarea type="text" id="editor" name="intro" style="height:100px;width: 100%" data-validate="required:请输入简介"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
