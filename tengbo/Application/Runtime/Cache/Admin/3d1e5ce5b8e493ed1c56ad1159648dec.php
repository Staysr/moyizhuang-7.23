...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <form method="post" action="<?php echo U('leave_word_list');?>" id="myform">
            <ul class="search" style="padding-left:10px;">
                ...
                <li>
                    <input type="text" placeholder="输入手机号" name="phone" value="<?php echo ($_REQUEST['phone']); ?>" class="input" style="width:250px; line-height:17px;display:inline-block"/>
                </li>
                <li>
...
<script type="text/javascript">
    function del(id, that) {
        if (confirm('确定删除吗')) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo U('System/leave_word_del');?>",
                data: {id: id},
