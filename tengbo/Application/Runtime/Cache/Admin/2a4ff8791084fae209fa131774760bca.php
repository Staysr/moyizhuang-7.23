...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="/tengbo/Public/ueditor2/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/tengbo/Public/ueditor2/ueditor.all.min.js"> </script>
    <!--<script type="text/javascript" charset="utf-8" src="/tengbo/Public/ueditor2/lang/zh-cn/zh-cn.js"></script>-->
</head>
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="number" class="input w50" value="" name="page_view" data-validate="number:请输入整数"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
