        ...
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips"><img class="image" src="<?php echo ($info["pic1"]); ?>" alt="<?php echo ($info["pic1"]); ?>"/></div>
                    <div class="tips" style="color: red;">图片尺寸：750*375</div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips"><img class="image" src="<?php echo ($info["pic2"]); ?>" alt="<?php echo ($info["pic2"]); ?>"/></div>
                    <div class="tips" style="color: red;">图片尺寸：750*375</div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips"><img class="image" src="<?php echo ($info["pic3"]); ?>" alt="<?php echo ($info["pic3"]); ?>"/></div>
                    <div class="tips" style="color: red;">图片尺寸：750*375</div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips"><img class="image" src="<?php echo ($info["pic4"]); ?>" alt="<?php echo ($info["pic4"]); ?>"/></div>
                    <div class="tips" style="color: red;">图片尺寸：750*375</div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <select name="class1" class="input w50 class1" data-validate="required:请选择分类">
                        <?php if(is_array($class1)): $i = 0; $__LIST__ = $class1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($$info['class1']) == $v['id']): ?>selected<?php endif; ?> ><?php echo ($v["class_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <select name="class2" class="input w50 class2" data-validate="required:请选择分类">
                        <?php if(is_array($class2)): $i = 0; $__LIST__ = $class2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($$info['class2']) == $v['id']): ?>selected<?php endif; ?> ><?php echo ($v["class_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <select name="class3" class="input w50 class3" data-validate="required:请选择分类">
                        <?php if(is_array($class3)): $i = 0; $__LIST__ = $class3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($$info['class3']) == $v['id']): ?>selected<?php endif; ?> ><?php echo ($v["class_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea type="text" id="content" name="content" style="height:100px;width: 100%" ><?php echo ($info["content"]); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <textarea type="text" id="param" name="param" style="height:100px;width: 100%" ><?php echo ($info["param"]); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <textarea type="text" id="intro" name="intro" style="height:100px;width: 100%" ><?php echo ($info["intro"]); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
