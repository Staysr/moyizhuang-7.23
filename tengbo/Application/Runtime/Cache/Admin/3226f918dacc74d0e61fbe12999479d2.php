	...
	<body>
		<div class="panel admin-panel">
			...
			<div class="padding border-bottom">
				<a class="button border-yellow" href="<?php echo U('Admin/admin_add');?>" ><span class="icon-plus-square-o"></span> 添加管理员</a>
			</div>
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<div class="button-group">
								<a class="button border-main" href="<?php echo U('Admin/admin_update',array('id'=>$v['id']));?>"><span class="icon-edit"></span>修改密码</a>
