    ...
    <div class="body-content">
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="job" data-validate="required:请输入岗位名称" />
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="address" data-validate="required:请输入工作地点"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="number" class="input w50" value="" name="num" data-validate="required:请输入人数,number:请输入合法人数"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="require" data-validate="required:请输入学历要求"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
