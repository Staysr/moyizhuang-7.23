...
<div class="panel admin-panel">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加团队人员</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="<?php echo ($info["name"]); ?>" name="name" data-validate="required:请输入名字" />
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="<?php echo ($info["post"]); ?>" name="post" data-validate="required:请输入岗位"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
