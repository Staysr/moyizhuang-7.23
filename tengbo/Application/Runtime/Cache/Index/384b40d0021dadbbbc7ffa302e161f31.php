...
<div class="container">
    <p class="container_nav"><a href="<?php echo U('Index/index');?>">首页</a> &nbsp>&nbsp <a href="">关于腾博</a> &nbsp>&nbsp  <a href="" class="active">荣誉证书</a></p>
    <p class="cul_title">荣誉证书</p>
    ...
    <div class="certificate">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
            <div class="pic"><img src="<?php echo ($vo["pic"]); ?>" alt=""></div>
