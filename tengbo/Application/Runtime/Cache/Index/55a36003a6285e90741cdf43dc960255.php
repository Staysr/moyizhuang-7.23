...
<div>
    ...
    <div class="page-head">
        ...
        <div class="scre-head">
            <ul class="head-nav">
                <li class="head-li"><a href="index.html">首页</a>

                </li
                ><li class="head-li"> <a href="javascript:;">关于腾博</a>

                <ul>
                    <li><a href="{U('Abouttp/index')}">公司概况</a></li>
                    <li><a href="{U('Abouttp/company_status')}">企业文化</a></li>
                    <li><a href="about_history.html">发展历史</a></li>
    ...
    <nav id="nav">
        <ul class="nav-ul">
            <li class="nav-li"><a href="index.html">首页</a>

            </li
            ><li class="nav-li"> <a href="javascript:;">关于腾博 > </a>
            <ul class="minul">
                <li><a href="about_tp.html">公司概况</a></li>
                <li><a href="about_cul.html">企业文化</a></li>
                <li><a href="about_history.html">发展历史</a></li>
                <li><a href="certificate.html">荣誉证书</a></li>
            </ul>
