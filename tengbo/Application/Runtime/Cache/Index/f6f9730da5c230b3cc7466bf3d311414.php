...
<div class="container">
    <p class="container_nav"><a href="javascript:;">首页</a> &nbsp>&nbsp <a href="javascript:;">关于腾博</a> &nbsp>&nbsp <a href="javascript:;" class="active">合作单位</a></p>
    <p class="cul_title">合作单位</p>

    <div class="about_coop-div about_coop-div1">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span><img src="<?php echo ($vo["pic"]); ?>" alt=""></span><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>

    <div class="about_coop-div"><span><img src="img/about/17.jpg" alt=""></span></div>
</div>
<div class="foote">
    <div class="foot-box">
        <ul>
