...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIj7aRIsPqcAZU"; // AccessKeyId

        $accessKeySecret = "iS6h7jsaGz2N1TH0PFYmCQhIZGsdSO"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($tap,$content) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($tap);

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("宝网璎珞");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_149416967");
     ...
     * @return stdClass
     */
    public static function querySendDetails($tel) {
