...
?>
         ...
         <div class="paging"> <a href="<?php  $feng=$_GET['u']; $newstr = substr($feng,0,strlen($feng)-1); $newstr1=str_replace("&","%26","$newstr");$ap12=explode("pageno=",$newstr1);$newstr1=$ap12[0];  $hello = explode('=',$feng); $hello1=intval($hello[2])-1;$boss="?u=".$newstr1."pageno=".$hello1;echo $boss;?>" target="_self">上一页</a>

          <a href="<?php  $feng=$_GET['u']; $newstr = substr($feng,0,strlen($feng)-1); $newstr1=str_replace("&","%26","$newstr");$ap12=explode("pageno=",$newstr1);$newstr1=$ap12[0];     $hello = explode('=',$feng); $hello1=intval($hello[2])+1;$boss="?u=".$newstr1."pageno=".$hello1;echo $boss;?>" target="_self">下一页</a>

         <a href="javascript:void(0);">当前第<?php echo $hello[2];?>页</a>
</div>
</div></div>
<div class="asst asst-list-footer"><?php echo $adaik['tv_ad'];?></div></section>
