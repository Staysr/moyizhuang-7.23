<?php
    ...
    $arr_active_languages = array(
        ...
        'cn'=>array('name'=>'Chinese', 'direction'=>'ltr'),
    );
    ...
    define('EI_CONFIG_FILE_DIRECTORY', '../conf/');
    ...
    define('EI_ALLOW_NEW_INSTALLATION', 1);        
    // *** specifies whether to allow update
    define('EI_ALLOW_UPDATE', 0);        
    // *** specifies whether to allow un-installation
    define('EI_ALLOW_UN_INSTALLATION', 0);        
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', '购啊购VIP电影系统');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'v3.7');
    ...
    if(file_exists("install.lock")) { header("Content-type: text/html; charset=utf-8"); echo "install.lock 存在,安装不进行,重新安装请删除install.lock";die();}
?>