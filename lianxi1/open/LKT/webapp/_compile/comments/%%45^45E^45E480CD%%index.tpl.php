<?php /* Smarty version 2.6.26, created on 2019-01-11 09:14:51
...
" id="" placeholder=" 订单编号" style="width:200px" class="input-text">
...
?>
                <tr class="text-c">
                    ...
                    <td style="width: 60px"><?php echo $this->_tpl_vars['item']->anonymous; ?>
</td>
