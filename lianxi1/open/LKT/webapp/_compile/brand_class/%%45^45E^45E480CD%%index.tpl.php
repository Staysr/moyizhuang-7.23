...
" style="width: 50px;height:50px;"/><?php else: ?><span>暂无图片</span><?php endif; ?></td>
                    ...
                    <td><?php if ($this->_tpl_vars['item']->status == 0): ?>启用<?php else: ?>禁用<?php endif; ?></td>
                    <td>
                        <?php if ($this->_tpl_vars['item']->status == 1): ?>
                            <a style="text-decoration:none" class="ml-5" href="javascript:void(0);" onclick="confirm1('确定要启用此商品品牌吗?',<?php echo $this->_tpl_vars['item']->brand_id; ?>
,'启用')" title="启用" >
                        ...
                        <?php elseif ($this->_tpl_vars['item']->status == 0): ?>
                            <a style="text-decoration:none" class="ml-5" href="javascript:void(0);" onclick="confirm1('确定要禁用此商品品牌吗?',<?php echo $this->_tpl_vars['item']->brand_id; ?>
,'禁用')" title="禁用" >
                            	<div style="align-items: center;font-size: 12px;display: flex;">
	                            	<div style="margin:0 auto;;display: flex;align-items: center;"> 
