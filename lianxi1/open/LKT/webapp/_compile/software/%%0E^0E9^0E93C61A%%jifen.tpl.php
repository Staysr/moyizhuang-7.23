<?php /* Smarty version 2.6.26, created on 2019-01-11 09:04:23
    ...
    <form name="form1" action="index.php?module=software&action=jifen" class="form form-horizontal" method="post" enctype="multipart/form-data" >
        <div class="row cl">
            ...
            <div class="formControls col-10 " >
                <input type="number" class="input-text" value="<?php echo $this->_tpl_vars['r'][0]->jifennum; ?>
" placeholder="" id="" name="jifennum">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">是否开启积分转让：</label>
            <div class="formControls col-10 " >
            <input type="radio" name="switch" value="0" <?php if ($this->_tpl_vars['r'][0]->switch == 0): ?> checked="checked"<?php endif; ?>>关闭 &nbsp;&nbsp; 
            <input type="radio" name="switch" value="1" <?php if ($this->_tpl_vars['r'][0]->switch == 1): ?> checked="checked"<?php endif; ?>>开启 &nbsp;&nbsp; 
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10"> 
                <script id="editor" type="text/plain" style="width:80%;height:400px;" name="rule"><?php echo $this->_tpl_vars['r'][0]->rule; ?>
</script> 
            </div>
        </div>
