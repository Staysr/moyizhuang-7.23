<?php /* Smarty version 2.6.26, created on 2019-01-11 09:13:21
         compiled from pageadd.tpl */ ?>
...
?>
                    <option value="<?php echo $this->_tpl_vars['item']->cid; ?>
...
<ul class="shortcut-element-box clearfix">
 ...
 <?php $_from = $this->_tpl_vars['products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['f1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['f1']['iteration']++;
?>
    ...
    <input type="hidden" value="../product/detail?productId=<?php echo $this->_tpl_vars['item']->id; ?>
">

    <span><?php echo $this->_tpl_vars['item']->product_title; ?>
</span>
...
?>
          ...
          <input type="hidden" value="../listdetail/listdetail?class=<?php echo $this->_tpl_vars['item']->cid; ?>
&title=<?php echo $this->_tpl_vars['item']->pname; ?>
">

          <span><?php echo $this->_tpl_vars['item']->str; ?>
<?php echo $this->_tpl_vars['item']->pname; ?>
</span>
...
<div class="examine-shortcut shortcut-element-list">
    ...
    <ul class="shortcut-element-box clearfix">
     ...
     <?php $_from = $this->_tpl_vars['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['f1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['f1']['iteration']++;
?>
        ...
        <input type="hidden" value="../article/article?id=<?php echo $this->_tpl_vars['item']->Article_id; ?>
">

        <span><?php echo $this->_tpl_vars['item']->Article_title; ?>
</span>
