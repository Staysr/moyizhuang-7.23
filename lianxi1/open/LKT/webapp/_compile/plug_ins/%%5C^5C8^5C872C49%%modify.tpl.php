<?php /* Smarty version 2.6.26, created on 2019-01-22 11:14:36
...
" placeholder="" id="" name="subtitle_name">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-4 skin-minimal">
            <div class="radio-box">
                <input name="type" type="radio" value="0" <?php if (type == 0): ?> checked="checked" <?php endif; ?> onclick="change()"/>
                <label for="sex-0">小程序</label>
            </div>
            <div class="radio-box">
                <input name="type" type="radio" value="1" <?php if (type == 1): ?> checked="checked" <?php endif; ?> onclick="change()"/>
...
" placeholder="" id="" name="sort">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-4">
        <input type="text" class="input-text" disabled value="<?php echo $this->_tpl_vars['http']; ?>
" placeholder="" id="" name="http">
      </div>
    </div>
    <div class="row cl">
