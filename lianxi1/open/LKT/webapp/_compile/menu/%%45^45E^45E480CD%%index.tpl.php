<?php /* Smarty version 2.6.26, created on 2019-01-11 09:15:07
...
" id="" placeholder="菜单id" style="width:200px" class="input-text">
            <input type="text" name="title" size='8' value="<?php echo $this->_tpl_vars['title']; ?>
" id="" placeholder="菜单名称" style="width:200px" class="input-text">
