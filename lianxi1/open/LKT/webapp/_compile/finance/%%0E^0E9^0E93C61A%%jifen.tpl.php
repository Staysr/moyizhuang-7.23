<?php /* Smarty version 2.6.26, created on 2019-01-22 11:42:52
...
" id="pagesize" />
			<div>
				...
				<input type="text" class="input-text" style="width:250px" placeholder="用户名" name="user_name" value="<?php echo $this->_tpl_vars['user_name']; ?>
">
