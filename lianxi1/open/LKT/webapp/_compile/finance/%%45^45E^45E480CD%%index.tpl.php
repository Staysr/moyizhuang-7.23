<?php /* Smarty version 2.6.26, created on 2019-01-22 11:42:49
...
" id="pagesize" />
			...
			<input type="text" class="input-text" style="width:250px" placeholder="用户名" name="name" value="<?php echo $this->_tpl_vars['name']; ?>
">
			<input type="text" class="input-text" style="width:250px" placeholder="卡号" name="Bank_card_number" value="<?php echo $this->_tpl_vars['Bank_card_number']; ?>
">
			<input type="text" class="input-text" style="width:250px" placeholder="持卡人姓名" name="Cardholder" value="<?php echo $this->_tpl_vars['Cardholder']; ?>
">
...
元</td>
	                    ...
	                    <td style="min-width: 180px">
							<a style="text-decoration:none" class="ml-5" href="index.php?module=finance&action=see&user_id=<?php echo $this->_tpl_vars['item']->user_id; ?>
" title="查看">
