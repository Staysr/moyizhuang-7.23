<?php /* Smarty version 2.6.26, created on 2019-01-22 11:42:51
...
" id="pagesize" />
			<div>
				...
				<input type="text" class="input-text" style="width:150px" placeholder="用户ID" name="name" value="<?php echo $this->_tpl_vars['name']; ?>
">
