<?php /* Smarty version 2.6.26, created on 2019-01-11 09:04:32
...
?>
                <tr class="text-c">
                    ...
                    <td><?php echo $this->_tpl_vars['item']->color_name; ?>
</td>
                    <td style="background-color:<?php echo $this->_tpl_vars['item']->color; ?>
 "></td>
                    <td><?php echo $this->_tpl_vars['item']->sort; ?>
</td>
                    <td><?php if ($this->_tpl_vars['item']->status == 0): ?><span style="color: #ff2a1f;">未启用</span><?php else: ?><span style="color: #30c02d;">已启用</span><?php endif; ?></td>
                    <td>    
                        <a style="text-decoration:none" class="ml-5" href="javascript:void(0);" onclick="confirm1('确定要使用这个颜色吗?',<?php echo $this->_tpl_vars['item']->id; ?>
)" title="启用" >
                        ...
                        <a style="text-decoration:none" class="ml-5" href="javascript:void(0);" onclick="confirm('确定要删除这个颜色吗?',<?php echo $this->_tpl_vars['item']->id; ?>
)">
                        	<div style="align-items: center;font-size: 12px;display: flex;">
                            	<div style="margin:0 auto;;display: flex;align-items: center;"> 
