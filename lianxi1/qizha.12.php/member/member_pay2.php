...
<div class="form-group">
	...
	<div class="col-sm-4">
	<input name="fee" maxlength="15" value="<?php echo str_replace(",","",$_REQUEST["money"])?>" title="nickname" class="form-control"  placeholder="元" >
...
<div class="form-group">
	<label for="oldpass" class="col-sm-2 control-label"><?php echo lang("充值金额/l/Address")?></label>
	<div class="col-sm-4">
	<input name="wx_fee" maxlength="15" value="<?php echo $_REQUEST["money"]?>" id="wx_fee" title="nickname" class="form-control"  placeholder="元" >
	<input type="hidden" value="<?php echo $_SERVER["HTTP_HOST"].$_SERVER["PHP_SELF"]?>" name="M_url">
	<input type="hidden" name="M_id" value="<?php echo $M_id?>">
	</div>
</div>
...
<div class="form-group">
	<label for="oldpass" class="col-sm-2 control-label"><?php echo lang("充值金额/l/Address")?></label>
	<div class="col-sm-4">
	<input name="amount" maxlength="15" value="<?php echo str_replace(",","",$_REQUEST["money"])?>" title="nickname" class="form-control"  placeholder="元" >
	</div>
</div>
<div class="form-group">
	<label for="oldpass" class="col-sm-2 control-label"><?php echo lang("付款方式/l/Address")?></label>
