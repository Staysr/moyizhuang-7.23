...
<?php }?>
				...
				<?php if ($C_Invitation!=0 || $C_1yuan2!=0){ ?>我的邀请链接：<u>http://<?php echo splitx($_SERVER["HTTP_HOST"].$_SERVER["PHP_SELF"],"/member",0)?>/member/member_reg.php?uid=<?php echo $M_id?></u> 复制给发送给好友吧！<?php }?>
			</div>
