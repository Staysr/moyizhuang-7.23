...
<p><?php echo lang("物流公司/l/Logistics company")?>：<?php echo $O_wl?></p>
...
echo "<tr><td>".$wl_info->data[$i]->time."</td><td>".$wl_info->data[$i]->location."</td><td>".$wl_info->data[$i]->content."</td></tr>";
}
