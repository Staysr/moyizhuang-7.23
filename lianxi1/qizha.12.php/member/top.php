...
if ($M_name!="未填写" && $M_name!="null"){
$f1=1;
}else{
$f1=0;
}
if($M_code!="未填写" && $M_code!="null"){
$f2=1;
}else{
$f2=0;
}
if($M_qq!="未填写" && $M_qq!="null"){
$f3=1;
}else{
$f3=0;
}
if($M_mobile!="未填写" && $M_mobile!="null"){
$f4=1;
}else{
$f4=0;
}
if($M_add!="未填写" && $M_add!="null"){
$f5=1;
}else{
$f5=0;
}
if($M_email!="未填写" && $M_email!="null"){
$f6=1;
}else{
$f6=0;
}
