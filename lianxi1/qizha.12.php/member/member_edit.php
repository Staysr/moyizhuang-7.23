...
<form id="userinfo_save" method="POST" action="?action=edit" class="form-horizontal" id="form">
                           <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								   <input name="M_login" maxlength="50" value="<?php echo $M_login?>" title="nickname" class="form-control" readonly>
								</div>
							</div>
														<div class="form-group">
								<label for="oldpass" class="col-sm-2 control-label"><?php echo lang("真实姓名/l/True Name")?></label>
								<div class="col-sm-4">
								   <input name="M_name" maxlength="50" value="<?php echo $M_name?>" title="nickname" class="form-control" >
								</div>
							</div>
								...
								<div class="col-sm-4">
								   <input name="M_QQ" maxlength="50" value="<?php echo $M_qq?>" title="nickname" class="form-control" >
								</div>
							</div>
														<div class="form-group">
								<label for="oldpass" class="col-sm-2 control-label"><?php echo lang("联系地址/l/Address")?></label>
								<div class="col-sm-4">
								   <input name="M_add" maxlength="50" value="<?php echo $M_add?>" title="nickname" class="form-control" >
								</div>
							</div>
								...
								<div class="col-sm-4">
								   <input name="M_code" maxlength="50" value="<?php echo $M_code?>" title="nickname" class="form-control" >
								</div>
							</div>
							<div class="form-group">
								<label for="oldpass" class="col-sm-2 control-label"><?php echo lang("手机号码/l/MobilePhone")?></label>
								<div class="col-sm-4" style="padding-top:7px; ">
								   <?php echo $M_mobile?> <a href="member_mobile.php" class="btn btn-xs btn-primary">修改</a>
								</div>
							</div>
							<div class="form-group">
								<label for="oldpass" class="col-sm-2 control-label"><?php echo lang("电子邮箱/l/E-mail")?></label>
								<div class="col-sm-4" style="padding-top:7px; ">
								   <?php echo $M_email?> <a href="member_email.php" class="btn btn-xs btn-primary">修改</a>
								</div>
							</div>
