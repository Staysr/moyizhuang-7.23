...
$sql="Select * from SL_member Where M_login like '".$M_login."' and M_pwd like '".$M_pwd."'";
...
$sql="Select * from SL_member Where M_mobile like '".$M_mobile."' and M_pwdcode like '".$_SESSION["login_code"]."' and M_pwdcode<>''";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
if (mysqli_num_rows($result) > 0) {
...
if($M_code==$_SESSION["login_code"]){
$sql="Select * from SL_member Where M_email like '".$M_email."' and M_pwdcode like '".$_SESSION["login_code"]."' and M_pwdcode<>''";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
if (mysqli_num_rows($result) > 0) {
$_SESSION["M_login"]=$row["M_login"];
