...
EOT;
	...
	{
	echo <<<EOT
		<div class="footer">&copy;2016 <a href="http://www.xpgcms.com/">小苹果CMS</a> Inc.</div>
	</div>
</div>
</body>
</html>
...
<div class="main" style="margin-top:-123px;">
	...
	请您在使用(小苹果CMS)前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
				一、安装和使用： <br />小苹果CMS是免费和开源提供给您使用的，您可安装无限制数量副本。 您必须保证在不进行非法活动，不违反国家相关政策法规的前提下使用本软件。 <br /><br />
二：郑重声明： <br />
...
<div id="form_items_3" ><br /><div class="desc"><b>填写网站配置信息</b></div>
	...
	<td><input class="txt" type="text" name="site_name" id="site_name" value="小苹果CMS" /></td>
	<td>网站的名称</td>
	</tr>
	...
	<td><input class="txt" type="text" name="db_server" id="db_server" value="localhost" /></td>
