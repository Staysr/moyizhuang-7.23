...
<div style="width:1000px; height:30px; margin:auto; position:relative; z-index:6;">
	<div style="width:1000px; height:400px; top:-430px; position:absolute; z-index:6; overflow:hidden;">
		<div style="width:150px; height:45px; background:#0067AC; position:absolute; z-index:7; color:#FFF; text-align:center; font-size:14px; line-height:42px; font-weight:bold; top:355px;">解决方案<img src="'.$this->_tpl_vars['saxue_skin_url'].'/images/arr.gif" style="margin-left:8px; margin-top:-2px;" /></div>
		<div class="solution" style="left:150px;">
			<p style="line-height:42px; padding-left:16px;"><img src="'.$this->_tpl_vars['saxue_skin_url'].'/images/icon/icon_1.png" height="28" style="margin-right:5px; margin-top:7px; float:left;" />企业门户</p>
			<p style="padding:10px 26px; line-height:180%;">互联网信息已经通达全球各个角落，而传播途径最快最有效的方式是企业网站，以此来宣传企业的产品，宣传企业的服务，展示企业形象，并通过网络与各行各业进行交流和合作。</p>
		</div>
		<div class="solution" style="left:360px;">
			<p style="line-height:42px; padding-left:16px;"><img src="'.$this->_tpl_vars['saxue_skin_url'].'/images/icon/icon_2.png" height="28" style="margin-right:10px; margin-top:7px; float:left;" />对外贸易</p>
			<p style="padding:10px 26px; line-height:180%;"></p>
		</div>
		<div class="solution" style="left:570px;">
			<p style="line-height:42px; padding-left:16px;"><img src="'.$this->_tpl_vars['saxue_skin_url'].'/images/icon/icon_3.png" height="28" style="margin-right:10px; margin-top:7px; float:left;" />移动互联</p>
			<p style="padding:10px 26px; line-height:180%;"></p>
		</div>
		<div class="solution" style="left:780px;">
			<p style="line-height:42px; padding-left:16px;"><img src="'.$this->_tpl_vars['saxue_skin_url'].'/images/icon/icon_4.png" height="28" style="margin-right:10px; margin-top:7px; float:left;" />电子商务</p>
			<P style="padding:10px 26px; line-height:180%;">企业电子商务的战略目标是如何借助互联网平台改造传统企业运作模式和渠道，分别在合理实验、出色运营的基础上，最终完成企业战略性的突破。</P>
		</div>
	</div>
</div>
...
<div id="main" style="height:306px;">
	...
	<div style="float:left; width:260px; margin-left:30px;">
		<div style="width:260px; height:130px; background:#0066AC; position:relative; z-index:1; cursor:pointer;" id="videoblcok" onclick="location.href=\'/job/\';">
			...
			<p style="padding-top:40px; padding-left:22px; color:#FFF; font-size:16px;">人力资源</p>
		...
		<div style="width:260px; height:130px; margin-top:10px; background:#DDD; position:relative; z-index:1; cursor:pointer;" id="showblock" onclick="location.href=\'/product/\';">
			...
			<p style="padding-top:40px; padding-left:22px; font-size:16px;">产品展示中心</p>
